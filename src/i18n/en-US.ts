export default {
  ...
  "webdav-port-placeholder": "Optional, e.g. 443",
  "webdav-folder-placeholder": "Optional sync folder, e.g. taby/backups",
  "webdav-filename-placeholder": "Sync filename, e.g. taby-sync.json",
  "webdav-username-placeholder": "WebDAV username, if authentication is needed",
  "webdav-password-placeholder":
    "WebDAV password or app password, if authentication is needed",
  port: "Port",
  folder: "Folder",
  filename: "Filename",
  "test-connection": "Test",
  "test-connection-success": "Connected",
  "test-connection-fail": "Connection failed",
  username: "Username",
  password: "Password",
  sync: "Sync",
  ...
  "sync-no-version-support":
    "The current sync type does not support version history",
