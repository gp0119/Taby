...
export const SYNC_BACKUP_TYPES = "syncBackupTypes"
export const SYNC_CONFIG_VERSION = "syncConfigVersion"
export const SYNC_GITHUB_GIST_ID = "githubGistId"
export const SYNC_GITHUB_GIST_TOKEN = "githubAccessToken"
export const SYNC_GITEE_GIST_ID = "giteeGistId"
export const SYNC_GITEE_GIST_TOKEN = "giteeAccessToken"
